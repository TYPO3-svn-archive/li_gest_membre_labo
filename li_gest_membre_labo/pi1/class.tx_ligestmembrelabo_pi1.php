	...
	function main($content,$conf)	{
		...
		while($row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($res))       {
			...
			//**************************************
				...
				$equipe_res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($equipe_select_fields, $equipe_from_table, $equipe_where_clause, $equipe_groupBy, $equipe_orderBy, $equipe_limit);
			...
			//**************************************
				...
				$categorie_res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($categorie_select_fields, $categorie_from_table, $categorie_where_clause, $categorie_groupBy, $categorie_orderBy, $categorie_limit);
			...
			//**************************************
				...
				$diplomes_res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($diplomes_select_fields, $diplomes_from_table, $diplomes_where_clause, $diplomes_groupBy, $diplomes_orderBy, $diplomes_limit);
			...
			//**************************************
				...
				$postes_res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($postes_select_fields, $postes_from_table, $postes_where_clause, $postes_groupBy, $postes_orderBy, $postes_limit);
			...
			//**************************************
				...
				$fonctionsstructures_res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($fonctionsstructures_select_fields, $fonctionsstructures_from_table, $fonctionsstructures_where_clause, $fonctionsstructures_groupBy, $fonctionsstructures_orderBy, $fonctionsstructures_limit);
